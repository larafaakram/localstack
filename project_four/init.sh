...
aws lambda update-function-code --function-name  getCoffee --zip-file fileb:///root/localstack/project/localstack/project_four/lambda/get/get.zip

# Create API Gateway REST API
aws apigateway create-rest-api --name 'CoffeeShop'
# Create route resources
aws apigateway create-route --api-id CoffeeShop --route-key "GET /coffee" 
